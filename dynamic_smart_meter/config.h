...
#define VOLTAGE_CAL           180// Adjusts raw ADC values to match physical AC Voltage scale
#define VOLTAGE_PHASE         -3  // Eliminates phase shift delays caused by transformer windings
#define CURRENT_CAL           19.0  // Adjusts raw ADC values to match physical Amperage scale
...
// #define LORA_INTERVAL_MS   10000  // Periodically send a background status report packet upstream every 5s
